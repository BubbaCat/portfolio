	  ...
	  <?php include( ROOT . 'templates/_parts/_errors.tpl') ?>
	   ...
	   <div class="form-download">
		 ...
		 <div class="form-download__container contacts-container-mod"> 
		   <fieldset>
								<input  type="file" name="file" id="postImg" class="inputfile" data-multiple-caption="{count} файлов выбрано" multiple />
								<label class="form-download__file-name" for="postImg">Выбрать файл</label> <span></span>
							</fieldset>
		 </div>
	   </div>
