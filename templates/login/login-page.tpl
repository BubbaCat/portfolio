  ...
  <div class="login-page__container">
    <div class="login-page__header">
      ...
      if ( $uri[0] == 'registration') { ?>
        <div class="header-user__right-link"><a href="<?=HOST?>login">Вход на сайт</a></div>
      <?php } else { ?>
        <div class="header-user__right-link"><a href="<?=HOST?>registration">Регистрация</a></div>
      <?php } ?>
...
<?=$content?>
    ...
    <div class="login-page__footer">
      <p class="footer-copy">© Сапов Евгений<br/>	Создано с <i class="fas fa-heart"> </i><a class="footer-link" href="http://webcademy.ru/" target="_blank"></a> в 2018 году</p>
    </div>
